...
class ArbitrageOpportunity(Base):
    ...
    sell_marketplace_id: Mapped[int] = mapped_column(Integer, ForeignKey("marketplaces.id"), nullable=False)
    buy_price_usd: Mapped[float] = mapped_column(Float, nullable=False)
    sell_price_usd: Mapped[float] = mapped_column(Float, nullable=False)
    sell_price_after_fee: Mapped[float] = mapped_column(Float, nullable=False)
    ...
    buy_marketplace: Mapped["Marketplace"] = relationship("Marketplace", foreign_keys=[buy_marketplace_id])
    sell_marketplace: Mapped["Marketplace"] = relationship("Marketplace", foreign_keys=[sell_marketplace_id])
