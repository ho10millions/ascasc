"""SkinCashier.com scraper."""

from app.scrapers.base import BaseScraper, ScrapedItem
from app.scrapers.utils import fetch_json, classify_item_type


class SkinCashierScraper(BaseScraper):
    marketplace_slug = "skincashier"
    marketplace_name = "SkinCashier"
    scraper_type = "playwright"

    API_URL = "https://skincashier.com/api/items"
