"""Skinomat.com scraper."""

from app.scrapers.base import BaseScraper, ScrapedItem
from app.scrapers.utils import fetch_json, classify_item_type


class SkinomatScraper(BaseScraper):
    marketplace_slug = "skinomat"
    marketplace_name = "Skinomat"
    scraper_type = "playwright"

    API_URL = "https://skinomat.com/api/items"
    ...
    async def scrape(self) -> list[ScrapedItem]:
        ...
        while page <= 30:
            data = await fetch_json(
                self.API_URL, params={"page": page, "per_page": 100, "sort": "price"},
            )
            if not data:
                break
