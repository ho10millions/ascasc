...
class AimMarketScraper(BaseScraper):
    marketplace_slug = "aim-market"
    marketplace_name = "Aim Market"
    scraper_type = "playwright"

    API_URL = "https://aim.market/api/items"
    ...
    async def scrape(self) -> list[ScrapedItem]:
        ...
        while page <= 30:
            data = await fetch_json(
                self.API_URL, params={"page": page, "limit": 100, "sort": "price_asc"},
            )
            if not data:
                break
