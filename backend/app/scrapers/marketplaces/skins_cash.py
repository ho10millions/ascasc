...
class SkinsCashScraper(BaseScraper):
    marketplace_slug = "skins-cash"
    marketplace_name = "Skins.Cash"
    scraper_type = "playwright"

    API_URL = "https://skins.cash/api/items"
    ...
    async def scrape(self) -> list[ScrapedItem]:
        ...
        results = data if isinstance(data, list) else data.get("data", data.get("items", []))
        for item in results:
